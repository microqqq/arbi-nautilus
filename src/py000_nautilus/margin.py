...
# Preserve the established 28-digit arithmetic, independently of caller context.
_CAPACITY_CONTEXT = Context(
    prec=28, rounding=ROUND_HALF_EVEN, Emin=-999999, Emax=999999, capitals=1, clamp=0,
...
def bitfinex_margin_capacity(
    *,
    ...
    """
    with localcontext(_CAPACITY_CONTEXT):
